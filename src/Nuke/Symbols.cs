...
public static partial class Symbols
{
    ...
    [GeneratedRegex("^Pack", RegexOptions.IgnoreCase | RegexOptions.Compiled, "en-US")]
    private static partial Regex MyRegex1();

    [GeneratedRegex("^Publish", RegexOptions.IgnoreCase | RegexOptions.Compiled, "en-US")]
    private static partial Regex MyRegex2();
    [GeneratedRegex("^Use", RegexOptions.IgnoreCase | RegexOptions.Compiled, "en-US")]
