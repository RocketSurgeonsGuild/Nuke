...
public interface ICanClean : IHaveCleanTarget, IHaveBuildTarget
{
    ...
    /// </summary>
    [NonEntryTarget]
    Target CleanWellKnownTemporaryFiles => d => d
                                                          .Before(Build)
                                                          ...
                                                          .Executes(
                                                               () =>
                                                               {
                                                                   ...
                                                                   // ReSharper disable SuspiciousTypeConversion.Global
                                                                   if (this is not IMayTheForceBeWithYou forceBeWithYou || !forceBeWithYou.Force) return;
                                                                   ...
                                                                   if (this is not IComprehendTests tests || !tests.TestsDirectory.DirectoryExists()) return;
